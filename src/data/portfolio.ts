...
export const projects: Project[] = [
  {
    ...
    blurb: 'decentralized music rental via NFTs, IP on Story Protocol, TEE-encrypted access via Lit Protocol',
  ...
  },
  {
    ...
    blurb: 'domain-aware paid-API gateway, x402 micropayments, dynamic SSL, anti-scraping via NGINX/OpenResty + Lua',
  ...
  },
  {
    ...
    blurb: 'production RAG system, LLMs + pgvector, Jina embeddings, LangChain memory, deployed on AWS',
  ...
  },
  {
    ...
    blurb: 'mobile sneaker marketplace, real-time sync, secure auth, REST APIs backed by MongoDB',
  ...
  },
  {
    ...
    blurb: 'live streaming platform, RTMP broadcasting, FFmpeg encoding, large-file storage via MongoDB GridFS',
  ...
  },
  {
    ...
    blurb: 'social media analytics at scale, cron pipelines, ML attention metrics, 1,000+ users on AWS',
...
export const experiences: Experience[] = [
  {
    ...
    blurb: 'RAG backend with LLMs + pgvector, Jina embeddings, LangChain memory, deployed on AWS',
  ...
  },
  {
    ...
    blurb: 'production backend systems, architecture, API design, database optimization, infra',
...
export const hackathons: Hackathon[] = [
  ...
  },
  {
    ...
    blurb: 'FHE-based confidential smart contracts on Fhenix L2, encrypted on-chain computation',
    result: 'Participant',
  ...
  },
  {
    ...
    blurb: 'HTTP 402 micropayment gateway, dynamic SSL, anti-scraping via NGINX/OpenResty + Lua',
    result: 'Participant',
